...
class CI_DB_cubrid_utility extends CI_DB_utility {
	...
	function _optimize_table($table)
	{
		...
		// table optimization can be performed using CUBRID Manager1
	...
	function _repair_table($table)
	{
		...
		// table consistency can be checked using CUBRID Manager1
		// database administration tool. See the link above for more info.
		return FALSE;
	}
	...
	{
		// No SQL based support in CUBRID as of version 8.4.0. Database or
		// table backup can be performed using CUBRID Manager1
