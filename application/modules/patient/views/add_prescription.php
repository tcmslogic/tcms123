...
<div class="one_wrap">
	<div class="widget_note">           
       ...
       <input type="hidden" name="patient_id" id="patient_id" value="<?php echo $patient_id; ?>">
      <input type="text" name="medication" id="medication" class="validate[required] text-input"  />
       </div></li>
       
       <li><div class="gender_id">Dosage:</div><div class="right_gender">
         <input type="text" name="dosage" id="dosage" class="validate[required] text-input"  />
       </div></li>     
       
             <li><div class="gender_id">Frequency:</div><div class="right_gender">
        <input type="text" name="frequency" id="frequency" class="validate[required] text-input"  />
       </div></li>                                                       
          </div>
    </div>
</div>    
