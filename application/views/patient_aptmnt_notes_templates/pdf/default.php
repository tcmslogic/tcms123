...
<div class="content" style="top:0px;margin:0 auto;width:80%;">
  ...
  <div id="header" style="width:100%;float:left;margin-bottom:5px;">
    ...
    <h3 style="text-align:right;float:right;width:50%;">Patient Appointment Report</h3>
  </div>
  ...
  <div id="invoice-items" style="margin:18px 0;float:left;width:100%;">
    <table class="table table-striped" style="width: 100%;float:left;">
      <tbody>    
        <tr>
          <th style="font-weight:bold;width: 85px;">Patient Name</th>
          <th style="font-weight:bold;width: 85px;">Next Appointment</th>
        </tr>
	...
	if($this->mdl_report->getAptmntCount($patient)!=""){ $date = date("d M Y",strtotime($this->mdl_report->getAptmntCount($patient))); }	
