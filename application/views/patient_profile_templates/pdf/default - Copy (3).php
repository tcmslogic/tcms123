...
/*.content .text_icon { float:left; margin-left:20px;}*/
p.icon_img span {
    float: left;
    position: absolute;
}
...
#icon_img {
    ...
    height: 16px;
    width: 16px;
	background:url(<?php echo base_url(); ?>assets/default/img/icons/mobile.png)
	background-repeat-x: no-repeat;
	background-repeat-y: no-repeat;}
...
#icon_img_email {
    ...
    height: 16px;
    width: 16px;
	background:url(<?php echo base_url(); ?>assets/default/img/icons/message.png)
	background-repeat-x: no-repeat;
	background-repeat-y: no-repeat;}	
...
#icon_img_office {
    ...
    height: 16px;
    width: 16px;
	background:url(<?php echo base_url(); ?>assets/default/img/icons/telephone.png)
	background-repeat-x: no-repeat;*/
	background-repeat-y: no-repeat;}	
  ...
  <div id="top_site">
    <div id="logo"><a href="http://192.168.2.113/tcms/index.php/dashboard"><img src="http://192.168.2.113/tcms/uploads/logo.png"></a></div>   	    
        ...
        <div class="main_containt">
        	<div class="content">
            	<label>Reference No.</label><span class="border" style="border-bottom:solid 1px #000;"><?php echo $patient_details->ref_no;?></span>
            </div>  
        	...
        	<div class="content">
              ...
              <div class="content" style="width:50%;">
                ...
                <span class="border" class="border" style="float:left;border-bottom:solid 1px #000!important;"><?php echo $patient_details->age;?></span>
            </div> 
             <div class="content">
            	<label style="float: left;">Profession:</label>
                 <span class="border" class="border" style="float:left;border-bottom:solid 1px #000!important;"><?php echo $patient_details->profession;?></span>
            </div> 
            <div class="content">
            	<div class="icon_mobile">
            		<!--div id="icon_img_email"></div-->
                    <span style="float: left;margin-right: 1%;margin-top: 2px;"><img src="<?php echo base_url(); ?>assets/default/img/icons/message.png"/></span>
           		     <label class="text_icon" style="float: left;">Mailing Address:</label>
                     <span class="border" class="border" style="float:left;border-bottom:solid 1px #000!important;"><?php echo $patient_details->email;?></span>
                     </div>
            </div> 
            <div class="content" style="width:50%;">
            	 	<!--div id="icon_img_office"></div-->
					<span style="float: left;margin-right: 1%;"><img src="<?php echo base_url(); ?>assets/default/img/icons/telephone.png"/></span>
                     ...
                     <span class="border" class="border" style="float:left;border-bottom:solid 1px #000!important;"><?php echo $patient_details->office_no;?></span>
                    </div>
                  <div class="content" style="width:50%;">  
                  <label style="float: left;">Home:</label>
                 <span class="border" class="border" style="float:left;border-bottom:solid 1px #000!important;"><?php echo $patient_details->home_no;?></span>
